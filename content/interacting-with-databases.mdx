...
<Aside type="info">
  Using statement bindings is the most secure way to send sensitive information
  to Litebase. Stament bindings is also more performant, as it allows staments
  to be prepared and cached.
</Aside>
